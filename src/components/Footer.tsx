          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-12">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="flex space-x-3 mb-4">
                <a href="#" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary transition-colors hover:bg-primary hover:text-white">
